...
\def\typeodoc{Laborationsrapport}
...
\begin{titlepage}
	...
	\begin{abstract}
       The goal in this test was to calculate the acceleration of a model car rolling downhill.
        The car was placed on a piece of wood with tracks ot hold the car in place.
       The track was then put at an angle så that the car complited the track in about one second.
        The car was filmed when it went down the track an the video was put in a program to calculate the position at the certaint times
    \end{abstract}
    \end{otherlanguage}
